...
**Created**: 2026-02-21
**Status**: Phase 1 in progress (Tasks 1.1-1.3 complete, 1.4-1.5 in progress)
...
- [ ] Notebook reproducing all original toy model results
- [ ] Notebook fitting Moche data with posterior distributions
- [ ] CSV of fitted parameters + effect sizes
- [ ] Bar plots: model vs empirical help rates per condition
